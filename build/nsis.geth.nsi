...
# 1. install gpop for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gpop
# 5. create gpop, attach and uninstall start menu entries
...
!define GROUPNAME "Popcateum"
!define APPNAME "Gpop"
!define DESCRIPTION "Official Go implementation of the Popcateum protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gpop is installed global
