...
// Package forkid implements EIP-2124 (https://eips.popcateum.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Popcateum fork ID from the chain config, genesis hash, and head.
