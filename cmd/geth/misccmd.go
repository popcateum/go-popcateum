...
var (
	VersionCheckUrlFlag = cli.StringFlag{
		...
		Value: "https://gpop.popcateum.org/docs/vulnerabilities/vulnerabilities.json",
	}
	VersionCheckVersionFlag = cli.StringFlag{
		Name:  "check.version",
		Usage: "Version to check",
		Value: fmt.Sprintf("Gpop/v%v/%v-%v/%v",
...
`,
	...
	versionCheckCommand = cli.Command{
		...
		Category:  "MISCELLANEOUS COMMANDS",
		Description: `
The version-check command fetches vulnerability-information from https://gpop.popcateum.org/docs/vulnerabilities/vulnerabilities.json, 
