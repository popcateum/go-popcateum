...
// setting up a new or managing an existing Popcateum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Popcateum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Popcateum network down to  |")
	...
	log.Info("Administering Popcateum network", "name", w.network)
