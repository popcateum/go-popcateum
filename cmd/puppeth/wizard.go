...
type wizard struct {
	...
	services map[string][]string   // Popcateum services known to be running on servers
...
// converts it to an Popcateum address. If an empty line is entered, the default
// value is returned.
