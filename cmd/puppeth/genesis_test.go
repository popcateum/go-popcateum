...
// Tests the go-popcateum to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_gpop.json")
	if err != nil {
...
// Tests the go-popcateum to Parity chainspec conversion for the Stureby testnet.
