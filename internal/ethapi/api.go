...
// PublicPopcateumAPI provides an API to access Popcateum related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicPopcateumAPI struct {
	b Backend
}

// NewPublicPopcateumAPI creates a new Popcateum protocol API.
func NewPublicPopcateumAPI(b Backend) *PublicPopcateumAPI {
	return &PublicPopcateumAPI{b}
}

// GasPrice returns a suggestion for a gas price.
func (s *PublicPopcateumAPI) GasPrice(ctx context.Context) (*hexutil.Big, error) {
...
func (s *PublicPopcateumAPI) Syncing() (interface{}, error) {
...
// keccack256("\x19Popcateum Signed Message:\n" + len(message) + message))
//
...
// PublicBlockChainAPI provides an API to access the Popcateum blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Popcateum blockchain API.
...
// PublicDebugAPI is the collection of Popcateum APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Popcateum APIs exposed over the private
// debugging endpoint.
